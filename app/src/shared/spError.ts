...
const SQL_ERROR_MAP: Record<number, string> = {
  ...
  50201: 'Tên đăng nhập đã tồn tại trong hệ thống.',
  50202: 'Số điện thoại đã được đăng ký cho tài khoản khác.',
  50204: 'Email đã được đăng ký cho tài khoản khác.',
  50205: 'Tên đăng nhập phải dài từ 3 đến 50 ký tự.',
  50206: 'Mật khẩu phải có ít nhất 8 ký tự.',
  50207: 'Số điện thoại không hợp lệ (phải gồm 9–15 chữ số).',
  50208: 'Email không hợp lệ.',
  50210: 'Thông tin tài khoản không khớp.',
