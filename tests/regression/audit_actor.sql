...
BEGIN TRY
    ...
    DECLARE @customer UNIQUEIDENTIFIER = 'A1000001-0000-0000-0000-000000000004';
    DECLARE @booking UNIQUEIDENTIFIER = 'B0000000-0000-0000-0000-A00100000000';
    ...
    DECLARE @start DATETIME2(0) = DATEADD(DAY, 20, CAST(CAST(SYSDATETIME() AS DATE) AS DATETIME2));
    SET @start = DATEADD(HOUR, 10, @start);
    INSERT dbo.Bookings(BookingId,UserId,CourtId,StartTime,EndTime,Status,TotalCost)
    VALUES (@booking,@customer,'C1000001-0000-0000-0000-000000000001',@start,DATEADD(HOUR,1,@start),N'PENDING',100000),
           (@customerBooking,@customer,'C1000001-0000-0000-0000-000000000002',@start,DATEADD(HOUR,1,@start),N'PENDING',100000),
           (@multiBooking,'A1000001-0000-0000-0000-000000000006','C1000001-0000-0000-0000-000000000003',@start,DATEADD(HOUR,1,@start),N'PENDING',100000);
